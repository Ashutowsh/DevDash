        ...
        <ul className='space-y-6'>
            {commits?.map((commit, idx) => {
                return <li key={commit.id} className='relative flex gap-x-4'>
                    ...
                    <>
                        <img src={commit.commitAuthorAvatar || '/default-avatar.png'} alt='commit avatar' className='relative mt-4 size-8 flex-none rounded-full bg-gray-50'/>
                        ...
                        <div className='flex-auto rounded-md bg-white p-3 ring-1 ring-inset ring-gray-200'>
                            <div className='flex justify-between gap-x-4'>
                                ...
                                <span className='font-medium text-gray-900'>{commit.commitAuthorAvatar}</span> {" "}
